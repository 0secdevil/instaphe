#!/bin/bash
# Coded by: github.com/0secdevil
# Instagram: @_black_de_evil__
...
printf "\e[1;92m _  | |                _            ____   _       _ __         \e[0m\n"
printf "\e[1;92m( \ | | ____    ___  _| |_  _____  |    | | |     | ___|        \e[0m\n"
printf "\e[1;92m ) )| ||  _ \  /___)(_   _)(____ | |  __| | |__   | |___        \e[0m\n"
printf "\e[1;77m(_/ | || | | ||___ |  | |_ / ___ | | |    |  _ \  | |__         \e[0m\n"
printf "\e[1;77m    |_||_| |_|(___/    \__)\_____| |_|    | | | | |____|        \e[0m\n"
printf "\n"
printf "\e[1;77m\e[45m  Instagram Brute Forcer v1.1 Author: @0secdevil   \e[0m\n"
printf "\n"
}
